...
@implementation UIDevice (MSCategory)
...
+ (BOOL)isIphone4
{
    ...
    dispatch_once(&onceToken, ^{
        isIphone4 = ([UIScreen mainScreen].bounds.size.height == 480.0);
    });
    return isIphone4;
}
...
+ (BOOL)isIphone5
{
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        isIphone5 = ([UIScreen mainScreen].bounds.size.height == 568.f);
    });
    return isIphone5;
}
